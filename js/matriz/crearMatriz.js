		...
		html += '<div class="panel-body">';
			html += '<div class="row">';
				...
				html += '<div class="col col-md-3">';
					html += '<label for="strike_'+error_n+'_'+count+'" class="control-label">Strike</label>';
					html += '<input type="number" name="strike_'+error_n+'_'+count+'" id="strike_'+error_n+'_'+count+'" class="form-control" required="" min="1" max="10">';
				html += '</div>';
