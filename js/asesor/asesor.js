			...
			for(var j = 1; j <= num_empresas; j++){
				...
				$.each(data, function(i, row){
					...
					if(empresa == 0){
						...
						html += '<div class="info-box bg-blue" onclick="javascript: pageContent(\'asesor/campanas\',  \'id_empresa='+row.id+'&empresa='+row.empresa+'\');" style="cursor:pointer;">';
